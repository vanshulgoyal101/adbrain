> Historical snapshot preserved September 26, 2026. Old task queues and readiness claims are not current instructions; use [the current roadmap](ROADMAP.md) and [worker dispatch](ORCHESTRATION.md).
